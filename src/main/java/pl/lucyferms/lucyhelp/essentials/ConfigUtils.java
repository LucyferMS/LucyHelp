package pl.lucyferms.lucyhelp.essentials;
...
import pl.lucyferms.lucyhelp.LucyHelp;
...
public class ConfigUtils {
    ...
    public static YamlConfiguration load(String configName){
        Plugin plugin = LucyHelp.getInstance();
    ...
    public static void save(YamlConfiguration c, String file) {
        try {
            c.save(new File(LucyHelp.getInstance().getDataFolder(), file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void save(YamlConfiguration c, String folder, String file){
        try {
            c.save(new File(LucyHelp.getInstance().getDataFolder() + File.separator + folder, file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
